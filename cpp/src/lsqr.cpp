...
void print_result(const LsqrResult& result) {
  ...
  std::cout << "r2norm: " << result.r2norm << std::endl;
  std::cout << "anorm: " << result.anorm << std::endl;
  std::cout << "acond: " << result.acond << std::endl;
  std::cout << "arnorm: " << result.arnorm << std::endl;
  std::cout << "xnorm: " << result.xnorm << std::endl;
}